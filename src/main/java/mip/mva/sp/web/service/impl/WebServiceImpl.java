...
public class WebServiceImpl implements WebService {
	 ...
	 */
	public WebServiceImpl(ConfigBean configBean, TrxInfoService trxInfoService, DirectService directService, VerifyManager verifyManager) {
				...
				if (ObjectUtils.isEmpty(trxInfo.getVp())) {
					...
					if (PresentTypeEnum.DID_VP.getVal() == presentType) {
						...
						try {
							...
							throw new SpException(MipErrorEnum.SP_UNEXPECTED_MSG_FORMAT, trxcode, "authCmmplete");
						}
	...
	public String rsaEncrypt(String data, String targetDid, Boolean isOaep) throws SpException {
		return verifyManager.rsaEncrypt(data, targetDid, true);
	}
	...
	public String rsaDecrypt(String data, Boolean isOaep) throws SpException {
		return verifyManager.rsaDecrypt(data, true);
	}
